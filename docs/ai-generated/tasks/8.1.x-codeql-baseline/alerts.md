...
- **Alert #704** — `java/path-injection` (high, CodeQL)
  - **Tool:** CodeQL
  - **State:** open
  - **Created:** 2026-08-15T00:32:59Z
  - **URL:** https://github.com/intersoftdatalabs-in/percussioncms-java8/security/code-scanning/704
  - **Location:** projects/sitemanage/src/main/java/com/percussion/theme/service/impl/PSThemeService.java:216
...
- **Alert #477** — `java/path-injection` (high, CodeQL)
  ...
  - **Location:** projects/sitemanage/src/main/java/com/percussion/theme/service/impl/PSThemeService.java:519
  - **Message:** This path depends on a user-provided value.
...
- **Alert #476** — `java/path-injection` (high, CodeQL)
  ...
  - **Location:** projects/sitemanage/src/main/java/com/percussion/theme/service/impl/PSThemeService.java:518
  - **Message:** This path depends on a user-provided value.
This path depends on a user-provided value.
...
- **Alert #467** — `java/path-injection` (high, CodeQL)
  ...
  - **Location:** projects/sitemanage/src/main/java/com/percussion/theme/service/impl/PSThemeService.java:182
  - **Message:** This path depends on a user-provided value.
This path depends on a user-provided value.
This path depends on a user-provided value.
This path depends on a user-provided value.
